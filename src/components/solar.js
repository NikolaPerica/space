...
class Solar extends Component {
  ...
  render() {
    ...
    return (
      <div class="grid h-screen place-items-center" style={{padding: '25px'}}>

      <h1 class="text-3xl flex justify-center items-center"><strong>Planets and Their Moons</strong></h1>
          ...
          <ul>
            {planets.map((planet) => (
              <li key={planet.id}>
                ...
                <h2 class="2xl" ><strong>{planet.englishName}</strong></h2>
